...
public class ManagerPage {
    ...
    By removeProfileloc=By.xpath("//ul[@class='profile-social-links']/child::li[2]/child::a[@href='mailto:"+AddUserProfilePage.emailOfManager+"']/parent::*/parent::*/following-sibling::button");
