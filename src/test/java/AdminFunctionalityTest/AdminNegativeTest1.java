...
public class AdminNegativeTest1 extends BaseClass {
    WebDriver driver;
    String projectlink = "https://hashedin-frontend-urtjok3rza-wl.a.run.app/";
    public static Logger logger = Logger.getLogger(AdminNegativeTest1.class);
    static ExtentReports extent = new ExtentReports();
//    static ExtentSparkReporter spark = new ExtentSparkReporter("AdminNegativeTest1.html");
//    ExtentTest test;
...
//      Thread.sleep(2000);
    ...
    public void verifyEmployeeTab() throws InterruptedException {
        ...
        test.pass("Successfully verified EmployeeTab");
    }
    @Test(priority = 4)
